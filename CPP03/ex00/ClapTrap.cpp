...
/*   Updated: 2025/01/24 10:39:53 by flmarsou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << GRAY << this->_name << " Copy Constructor Called" RESET << std::endl;
}
...
ClapTrap	&ClapTrap::operator=(const ClapTrap &other)
{
	...
	std::cout << GRAY << this->_name << " Copy Assignment Constructor Called" RESET << std::endl;
	return (*this);
}
